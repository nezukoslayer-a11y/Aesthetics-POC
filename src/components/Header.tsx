...
export const Header: React.FC = () => {
  ...
  return (
    <header
      id="mainHeader"
      className="fixed top-0 left-72 right-0 h-20 bg-[#fbf9f6]/90 backdrop-blur-md z-30 px-6 flex items-center justify-between border-b border-[#d2c5b2]/30 shadow-[0_1px_8px_rgba(0,0,0,0.03)]"
    >
      {/* Left side: Facility Selector + Search */}
      <div className="flex items-center gap-4">
        ...
        <div className="relative">
          <button
            ...
            className="flex items-center gap-2 px-3 py-1.5 rounded-xl bg-[#f5f3f0] hover:bg-[#eae8e5] text-[#1b1c1a] border border-[#d2c5b2]/40 transition-colors"
          >
            <span className="material-symbols-outlined text-[#7b5808] text-base">domain</span>
            <span className="font-label-md text-[11px] tracking-wider uppercase font-semibold text-[#1b1c1a]">
              {currentBranch}
            </span>
            <span className="font-label-sm text-[10px] px-1.5 py-0.5 rounded bg-[#e4e2df] text-[#625d5b]">
              Facility
            </span>
            <span className="material-symbols-outlined text-[#625d5b] text-sm">
              keyboard_arrow_down
            </span>
          </button>
              ...
              {branches.map((b) => (
                ...
                >
                  <div className="flex flex-col">
                    ...
                    <span className="text-[10px] text-[#625d5b]">{b.label}</span>
                  </div>
        ...
        >
          <span className="material-symbols-outlined absolute left-3 text-[#625d5b] text-base group-hover:text-[#7b5808] transition-colors">
            search
          </span>
          <input
            readOnly
            className="w-80 pl-9 pr-14 py-1.5 rounded-xl bg-[#f5f3f0] text-[#1b1c1a] font-body-sm text-[13px] placeholder:text-[#625d5b] focus:outline-none group-hover:bg-white border border-[#d2c5b2]/30 group-hover:border-[#7b5808] transition-all cursor-pointer"
            placeholder="Search records, injectables, charts..."
            type="text"
          />
          <kbd className="absolute right-2 px-1.5 py-0.5 rounded bg-[#efeeeb] font-label-sm text-[10px] text-[#625d5b] border border-[#d2c5b2]/40 font-mono">
            ⌘K
          </kbd>
        </div>
      </div>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          ...
          {isNotificationOpen && (
            <div className="absolute right-0 mt-2 w-80 rounded-xl bg-white border border-[#d2c5b2]/40 shadow-2xl p-3 z-40 flex flex-col gap-2">
              ...
              <div className="flex flex-col gap-2 text-xs">
                <div className="p-2 rounded-lg bg-amber-50 border border-amber-200 flex items-start gap-2">
                  <span className="material-symbols-outlined text-amber-700 text-sm mt-0.5">
                    warning
                  </span>
                  <div>
                    <div className="font-bold text-amber-950">Botox 100U Low Stock</div>
                ...
                <div className="p-2 rounded-lg bg-emerald-50 border border-emerald-200 flex items-start gap-2">
                  <span className="material-symbols-outlined text-emerald-700 text-sm mt-0.5">
                    check_circle
                  </span>
                  <div>
                    <div className="font-bold text-emerald-950">Vivian Chen Checked-In</div>
                ...
                <div className="p-2 rounded-lg bg-rose-50 border border-rose-200 flex items-start gap-2">
                  <span className="material-symbols-outlined text-rose-700 text-sm mt-0.5">
                    pending_actions
                  </span>
                  <div>
                    <div className="font-bold text-rose-950">1 Consent Form Renewal Due</div>
        ...
        {/* Doctor profile */}
        <div className="flex items-center gap-3 pl-3 border-l border-[#d2c5b2]/40">
          <div className="flex flex-col text-right">
            <span className="font-title-md text-[13px] text-[#1b1c1a] font-semibold leading-tight">
              Dr. Claire Sterling, MD
            </span>
            <span className="font-label-sm text-[10px] text-[#7b5808] font-bold uppercase tracking-widest mt-0.5">
              Medical Director
            </span>
          </div>
          <img
            alt="Dr. Claire Sterling, MD Profile"
            className="w-9 h-9 rounded-full object-cover ring-2 ring-[#7b5808]/30 shadow-xs"
